...
export default function Footer() {
  return (
    <div className="footer">
      ...
      <a href="https://www.facebook.com/brent.miller.338/">
        <img src="/images/footerlink-facebook.png" width="30px"></img>
      </a>
      <img src="/images/footerlink-instagram.png" width="30px"></img>
      <img src="/images/footerlink-twitter.png" width="30px"></img>
      <a href="http://linkedin.com/in/brent-miller-736109182">
        <img src="/images/linkedin.jpg" width="30px"></img>
      </a>
      <h6>Brent Miller</h6>
      <h6>802-730-3373</h6>
