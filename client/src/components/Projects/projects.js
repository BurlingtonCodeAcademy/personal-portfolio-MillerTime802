  ...
  return (
    <div className="pjct-center">
      ...
      <li>
        <a
          target="_blank"
          href="https://github.com/BurlingtonCodeAcademy/guess-the-number-MillerTime802"
        >
      ...
      <li>
        <a
          target="_blank"
          href="https://github.com/BurlingtonCodeAcademy/zorkington-brent-ben"
        >
          Text adventure game
        </a>
      </li>
