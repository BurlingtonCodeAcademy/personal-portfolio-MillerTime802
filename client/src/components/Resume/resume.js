...
export default function Resume() {
  return (
    <div className="resume-center">
      ...
      <li>
        Food and Beverage Manager - Trapp Family Lodge- September 2016 to August
        2020
      </li>
      <li>
        Bar Manager - Stowe Mountain Lodge- November 2010 to September 2016{" "}
      </li>
      ...
      <p>
        I hope to join a great team and do what I can to make a positive impact
        on the business and those around me.{" "}
      </p>
    </div>
  );
}
